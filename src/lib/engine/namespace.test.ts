...
import { addNamespaceToKeys, extractNamespace, setNamespaceInEvent } from './namespace';
...
test('extractNamespace', () => {
    expect(extractNamespace('missing_form/form_filled_fine_unpaid')).toEqual('missing_form');
});
